...
class jBPMGenericCalloutFHIRResource extends FHIRDomainResource
{
    /**
     ...
     */
    public function setPatient(FHIRReference $patient): jBPMGenericCalloutFHIRResource
    {
    ...
    public function jsonSerialize()
    {
        ...
        $json['resourceType'] = 'jBPMGenericCalloutResource';
