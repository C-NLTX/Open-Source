...
class jBPMGenericCalloutRestController
{
    /**
     * @var CustomSkeletonFHIRResourceService
     */
    private $jBPMGenericCalloutResourceService;
    ...
    {
        $this->jBPMGenericCalloutResourceService = new jBPMGenericCalloutFHIRResourceService();
     ...
     */
    public function getOneResource($fhirId, HttpRestRequest $request) : jBPMGenericCalloutFHIRResource
    {
        if ($request->isPatientRequest()) {
            // only allow access to data of binded patient
    ...
    {
        $processingResult = $this->jBPMGenericCalloutResourceService->getAll($searchParams, $puuidBind);
        $bundleEntries = array();
        ...
        $bundleSearchResult = $this->fhirService->createBundle('jBPMGenericCalloutResource', $bundleEntries, false);
    ...
    {
        $processingResult = $this->jBPMGenericCalloutResourceService->getOne($fhirId, $puuidBind);
