...
class jBPMGenericCalloutFHIRResourceService extends FhirServiceBase implements IPatientCompartmentResourceService
{
    /**
...
//    use FhirServiceBaseEmptyTrait;
    ...
    public function __construct($fhirApiURL = null)
    {
        ...
        $this->dataStore = new jBPMGenericCalloutDataStore();
    }
    ...
    {
        $fhirResource = new jBPMGenericCalloutFHIRResource();
    ...
    protected function searchForOpenEMRRecords($openEMRSearchParameters): ProcessingResult
    {
        ...
        if (
            ...
            foreach ($searchValues as $tokenValue) {
                 ...
                 */
                $value = $tokenValue->getCode();
                $records = $this->dataStore->getByResponse($value);
                if (!empty($records)) {
